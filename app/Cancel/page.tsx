  ...
  return (
    <div className="bg-grid min-h-screen font-sans py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <main>
          {/* Intro */}
          <PolicySection title="Cancellation and Refund Policy for Subscription-based Services">
          ...
          <PolicySection title="Subscription Services">
          ...
          <PolicySection title="Non-subscription services">
          ...
          <PolicySection title="Refund policy for businesses">
          ...
          <PolicySection title="Cancellation procedure">
          ...
          <PolicySection title="Cancellation and Refund for Special Cases">
